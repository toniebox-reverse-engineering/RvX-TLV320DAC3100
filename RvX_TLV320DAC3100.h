#ifndef RvX_TLV320DAC3100_h
#define RvX_TLV320DAC3100_h

#include <stdint.h>
#include <Wire.h>

class RvX_TLV320DAC3100 {
    public:
        ...
        void
            beep(),
            beepMidi(uint8_t midiId, uint16_t lengthMs, bool async=false),
            beepRaw(uint16_t sin, uint16_t cos, uint32_t length),
            beepRaw(uint16_t sin, uint16_t cos, uint32_t length, uint8_t volume);
